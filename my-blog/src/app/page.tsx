                ...
                <div className="flex flex-col h-full">
                  <div className="flex-1">
                    <Link href={`/blog/${post.slug}`}>
                      <h3 className={`font-semibold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors mb-3 line-clamp-2 ${
